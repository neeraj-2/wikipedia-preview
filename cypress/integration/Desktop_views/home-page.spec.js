...
describe('Testing HomePage', () => {
  ...
  it('Check English Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(1) > a > div.title').should('have.css', 'font-size', '18px') 
  })
  ...
  it('Check Bahasa Indonesia Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(2) > a > div.title').should('have.css', 'font-size', '18px') 
  })
  ...
  it('Check Hindi Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(3) > a > div.title').should('have.css', 'font-size', '18px') 
  })
  ...
  it('Check Thai Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(4) > a > div.title').should('have.css', 'font-size', '18px') 
  })
  ...
  it('Check Spanish Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(5) > a > div.title').should('have.css', 'font-size', '18px') 
  ...
  it('Check French Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(6) > a > div.title').should('have.css', 'font-size', '18px') 
  })
